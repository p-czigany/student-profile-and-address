...
class AddressClientTest {
    ...
    public void before() {
        ...
        WireMock
                .stubFor(WireMock.get(WireMock.urlEqualTo("/address"))
                        .willReturn(WireMock.aResponse()
                                .withStatus(HttpStatus.OK)
                                .withHeader(HttpHeaders.CONTENT_TYPE, MediaTypes.APPLICATION_JSON)
                                .withBody("{ \"id\": \"123e4567-e89b-12d3-a456-426614174000\", \"address\": \"address placeholder\" }")
                        )
                );
